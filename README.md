...
uv tool install git+https://github.com/asimons81/hermes-vault.git@v0.25.1

# Or with pipx
pipx install git+https://github.com/asimons81/hermes-vault.git@v0.25.1
